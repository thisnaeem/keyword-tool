...
import { IconSearch, IconPhoto, IconTrendingUp, IconBriefcase, IconTree, IconDevices, IconHeart, IconCup, IconHeartbeat, IconSchool, IconPlane, IconBarbell, IconUsers, IconBuilding, IconHanger, IconAtom, IconLeaf, IconMovie, IconPaw, IconCoin, IconPalette } from '@tabler/icons-react';
  ...
  const fetchKeywords = async (selectedCategory: string) => {
    ...
    try {
      ...
      if (errorMessage.includes('SAFETY')) {
        setError('Content was blocked due to safety filters. Please try a different category or rephrase your request.');
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleCustomCategory} className="flex gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-primary hover:bg-primary/90 
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        {loading ? (
          <div className="flex justify-center p-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="grid gap-4 mt-8">
              {keywords.map((kw, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl space-y-4 md:space-y-0"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {platformLinks.map((platform) => (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200"
                      >
